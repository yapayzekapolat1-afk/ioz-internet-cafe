...
(function () {
  ...
  var TRANSLATIONS = {
    tr: {
      ...
      "changelog.title": "Yenilikler — Sürüm 2.0",
      "changelog.intro": "Cafeni açtığından beri epey şey değişti, hepsi burada:",
      "changelog.1.b": "20 masa ve bilgisayar", "changelog.1.t": "— kapasite ikiye katlandı.",
      "changelog.2.b": "2 yeni donanım seviyesi", "changelog.2.t": "— İoz X 2027 ve İoz X 2030.",
      "changelog.3.b": "İOZ Playstion", "changelog.3.t": "— 10 adede kadar konsol istasyonu, 5 seviyeli yükseltme.",
      "changelog.4.b": "Dükkan", "changelog.4.t": "— hızlı servis, gelir artışı, müşteri verimliliği ve otomatik kabul yükseltmeleri.",
      "changelog.5.b": "Otomatlar", "changelog.5.t": "— içecek ve yiyecek otomatı, saatlik pasif gelir.",
      "changelog.6.b": "Temizlikçi ve Dükkan Puanı", "changelog.6.t": "— hizmet kalitene göre 0-10 arası puan.",
      "changelog.7.b": "Başarımlar", "changelog.7.t": "— XP kazan, seviye atla, bonus kap.",
      "changelog.8.b": "Sosyal ödüller", "changelog.8.t": "— TikTok, WhatsApp ve Play Store'da bizi bul, ödülünü kap.",
      ...
      "how.4.title": "Büyü", "how.4.desc": "En fazla 20 masa ve 20 bilgisayar. Boş duran masa gider yazdırır, dengeyi koru.",
      ...
      "social.tiktok.note": "Bizi takip et, ödülünü bir kereye mahsus oyun içinde alabilirsin.",
      "social.whatsapp.title": "İOZ Games Duyuru Kanalı",
      "social.whatsapp.handle": "WhatsApp Kanalı",
      "social.whatsapp.open": "Kanala Katıl",
      "social.whatsapp.note": "Kanala katıl, ödülünü bir kereye mahsus oyun içinde alabilirsin.",
      "social.rateus.title": "Bizi Play Store'da Değerlendir",
      "social.rateus.handle": "Beğendiysen 5 yıldız bırak ⭐",
      "social.rateus.note": "Play Store'u açar, değerlendirdikten sonra bir kereye mahsus ödülünü buradan alabilirsin.",
      "social.rewardClaimed": "Ödül Alındı ✓",
      "social.claimReward": "{amount} ₺ Ödülünü Al",
      "social.openPlayStore": "Play Store'u Aç",
      "social.rateAndClaim": "Değerlendir ve {amount} ₺ Al",
      ...
      "achv.full_capacity.name": "Tam Kapasite", "achv.full_capacity.desc": "20/20 masa ve bilgisayara ulaş.",
      ...
      "achv.shop_all.name": "Dükkan Koleksiyoncusu", "achv.shop_all.desc": "Dükkandaki 4 ürünü de satın al.",
    ...
    en: {
      ...
      "changelog.title": "What's New — Version 2.0",
      "changelog.intro": "A lot has changed since you last opened your cafe — here's everything:",
      "changelog.1.b": "20 tables and computers", "changelog.1.t": "— capacity has doubled.",
      "changelog.2.b": "2 new hardware tiers", "changelog.2.t": "— İoz X 2027 and İoz X 2030.",
      "changelog.3.b": "İOZ Playstion", "changelog.3.t": "— up to 10 console stations, 5 upgrade tiers.",
      "changelog.4.b": "The Store", "changelog.4.t": "— fast service, revenue boost, customer efficiency and auto-accept upgrades.",
      "changelog.5.b": "Vending machines", "changelog.5.t": "— drink and snack machines, passive hourly income.",
      "changelog.6.b": "Cleaner & cafe rating", "changelog.6.t": "— a 0-10 score based on your service quality.",
      "changelog.7.b": "Achievements", "changelog.7.t": "— earn XP, level up, grab bonuses.",
      "changelog.8.b": "Social rewards", "changelog.8.t": "— find us on TikTok, WhatsApp and the Play Store for a reward.",
      ...
      "how.4.title": "Grow", "how.4.desc": "Up to 20 tables and 20 computers. An idle table still costs you money, so keep things balanced.",
      ...
      "social.tiktok.note": "Follow us and claim your one-time in-game reward.",
      "social.whatsapp.title": "İOZ Games Announcement Channel",
      "social.whatsapp.handle": "WhatsApp Channel",
      "social.whatsapp.open": "Join the Channel",
      "social.whatsapp.note": "Join the channel and claim your one-time in-game reward.",
      "social.rateus.title": "Rate Us on the Play Store",
      "social.rateus.handle": "Leave 5 stars if you're enjoying it ⭐",
      "social.rateus.note": "Opens the Play Store — you can claim your one-time reward here afterward.",
      "social.rewardClaimed": "Reward Claimed ✓",
      "social.claimReward": "Claim {amount} ₺ Reward",
      "social.openPlayStore": "Open Play Store",
      "social.rateAndClaim": "Rate Us & Claim {amount} ₺",
      ...
      "achv.full_capacity.name": "Full Capacity", "achv.full_capacity.desc": "Reach 20/20 tables and computers.",
      ...
      "achv.shop_all.name": "Store Collector", "achv.shop_all.desc": "Buy all 4 items in the store.",
  ...
  var MAX_LEVEL = 7;
  // TEST DEĞERİ: normalde 1000 ₺. Yeni içerikleri (masa 20, seviye 6-7,
  // dükkan ürünleri) hızlı test edebilmek için geçici olarak yükseltildi.
  // Yayına almadan önce 1000'e geri döndürülmeli.
  var START_MONEY = 1000000;
  ...
  var ACHIEVEMENTS = [
    ...
    { id: "shop_first", xp: 100,
      check: function (st) {
        return st.shop.fastServe || st.shop.revenueBoost || st.shop.customerBoost || st.shop.autoAccept;
      } },
    { id: "shop_all", xp: 500,
      check: function (st) {
        return st.shop.fastServe && st.shop.revenueBoost && st.shop.customerBoost && st.shop.autoAccept;
  ...
  function freshStations() {
    ...
    // İOZ Playstion: 2 dedicated console slots, separate from the 20-slot
    // PC pool. Same station shape (isPS flags which level table applies).
  ...
  function freshState() {
    return {
      ...
      shop: { fastServe: false, revenueBoost: false, customerBoost: false, autoAccept: false },
      tiktokClaimed: false,
      ...
      vending: { drink: false, food: false },
      vendingAccrued: 0,
      staff: { cleaner: false },
      rating: 7.0,
      rateUsClaimed: false,
  ...
  function load() {
    try {
      ...
      if (!parsed.vending) parsed.vending = { drink: false, food: false };
  ...
  function dailyRunningCost() {
    ...
    state.stations.forEach(function (s) {
      if (s.hasComputer) total += levelsFor(s)[s.computerLevel].dailyCost || 0;
    });
      ...
      if (!s.hasTable) {
        el.innerHTML = s.isPS
          ? '<svg class="i-20 icon-plus"><use href="#icon-plus"/></svg>' +
            '<span class="station-label">PS Masası</span>'
          : '<svg class="i-20 icon-plus"><use href="#icon-plus"/></svg>' +
            '<span class="station-label">Boş Alan</span>';
      } else {
        var label = s.occupied ? s.customerName
          : (s.hasComputer ? levelsFor(s)[s.computerLevel].name : (s.isPS ? "Konsol yok" : "Bilgisayar yok"));
        el.innerHTML =
  ...
  function tick() {
    ...
    while (gameMinutes > 0 && !state.dayOver) {
      ...
      if (state.vending.drink || state.vending.food) {
        var perMin = 0;
      ...
      state.stations.forEach(function (s, idx) {
        ...
        if (state.clockMin >= s.sessionEndMin) {
          // "Gelir Artışı" dükkan ürünü: +%20 net kazanç.
          var earned = state.shop.revenueBoost ? Math.round(s.payout * 1.2) : s.payout;
          state.money += earned;
  ...
  function endDay() {
    ...
    // Dükkan puanı (0-10): kaybedilen müşteri oranı ve temizlikçi durumuna
    // göre günlük bir hedef puan hesaplanır, mevcut puanla harmanlanır
    // (EMA) — tek kötü/iyi gün puanı aniden sıçratmaz, gerçekçi durur.
    ...
    var target = 7 + cleanBonus - lostRatio * 4;
  ...
  var AD_BONUS_QUICK_REWARD = 5000;
  ...
  btnSavePrice.addEventListener("click", function () {
    ...
    var walkedOut = 0;
    if (s.hasComputer) {
      var ceiling = levelsFor(s)[s.computerLevel].maxAcceptRate;
      state.requests = state.requests.filter(function (r) {
  ...
  function upgradeStation(idx) {
    ...
    if (state.money < cur.upgradeCost) return showToast(t("toast.notEnoughMoney"));
  ...
  var SHOP_ITEMS = [
    { id: "fastServe", price: 5000, icon: "icon-shop-speed" },
    { id: "revenueBoost", price: 10000, icon: "icon-shop-revenue" },
    { id: "customerBoost", price: 15000, icon: "icon-shop-customers" },
    { id: "autoAccept", price: 500, icon: "icon-shop-auto" }
  ];
  ...
  // ---------------------------------------------------------------- tiktok reward
  // Honor-system reward: the app has no way to verify a follow server-side,
  // same pattern most mobile games use for "follow us" bonuses. Claimable
  // once per save file.
  var TIKTOK_REWARD = 5000;
  ...
  if (btnTiktokClaim) {
    btnTiktokClaim.addEventListener("click", function () {
      if (!state || state.tiktokClaimed) return;
  ...
  // ---------------------------------------------------------------- whatsapp channel reward
  // Same honor-system, one-time-per-save pattern as the TikTok reward above.
  var WHATSAPP_REWARD = 5000;
  var btnWhatsappClaim = $("btn-whatsapp-claim");

  function renderWhatsappClaim() {
    if (!state || !btnWhatsappClaim) return;
    if (state.whatsappClaimed) {
      btnWhatsappClaim.textContent = t("social.rewardClaimed");
      btnWhatsappClaim.disabled = true;
    } else {
      btnWhatsappClaim.textContent = t("social.claimReward", { amount: fmtMoney(WHATSAPP_REWARD) });
      btnWhatsappClaim.disabled = false;
    }
  }

  if (btnWhatsappClaim) {
    btnWhatsappClaim.addEventListener("click", function () {
      if (!state || state.whatsappClaimed) return;
      state.whatsappClaimed = true;
      state.money += WHATSAPP_REWARD;
      renderWhatsappClaim();
      renderHud();
      save();
      showToast(t("toast.whatsappThanks", { amount: fmtMoney(WHATSAPP_REWARD) }));
    });
  }
      ...
      if (!s.hasTable) {
        html += '<div class="store-item">' +
          ...
          '<button class="ps-action-btn" data-action="ps-table" data-idx="' + idx + '"' +
            (state.money < PS_TABLE_COST ? " disabled" : "") + '>' + fmtMoney(PS_TABLE_COST) + ' ₺</button>' +
        '</div>';
        ...
        html += '<div class="store-item">' +
          ...
          '<button class="ps-action-btn" data-action="ps-console" data-idx="' + idx + '"' +
            (state.money < PS_CONSOLE_COST ? " disabled" : "") + '>' + fmtMoney(PS_CONSOLE_COST) + ' ₺</button>' +
        '</div>';
      } else {
  ...
  if (psStoreList) {
    psStoreList.addEventListener("click", function (e) {
      ...
      if (action === "ps-table") {
        if (state.money < PS_TABLE_COST) return showToast(t("toast.notEnoughMoney"));
        s.hasTable = true;
        state.money -= PS_TABLE_COST;
        showToast(t("toast.psTableBuilt"));
      } else if (action === "ps-console") {
        if (state.money < PS_CONSOLE_COST) return showToast(t("toast.notEnoughMoney"));
        s.hasComputer = true;
        s.computerLevel = 1;
        s.rate = PS_LEVELS[1].defaultRate;
        state.money -= PS_CONSOLE_COST;
  ...
  function renderVendingSection() {
    ...
    var items = [
      { id: "drink", name: t("vending.drink.name"), desc: t("vending.drink.desc", { rate: VENDING_DRINK_RATE_PER_HOUR }), cost: VENDING_DRINK_COST, icon: "icon-drink" },
      { id: "food", name: t("vending.food.name"), desc: t("vending.food.desc", { rate: VENDING_FOOD_RATE_PER_HOUR }), cost: VENDING_FOOD_COST, icon: "icon-snack" }
    ];
  ...
  if (vendingStoreList) {
    vendingStoreList.addEventListener("click", function (e) {
      ...
      if (!btn || btn.disabled) return;
      var id = btn.dataset.id;
      var cost = id === "drink" ? VENDING_DRINK_COST : VENDING_FOOD_COST;
      if (state.vending[id]) return;
      ...
      renderHud();
      save();
      showToast((id === "drink" ? t("vending.drink.name") : t("vending.food.name")) + t("toast.installedSuffix"));
    });
  }
  ...
  function renderRateUsButton() {
    if (!btnRateUs || !state) return;
    btnRateUs.textContent = state.rateUsClaimed ? t("social.openPlayStore") : t("social.rateAndClaim", { amount: RATE_US_REWARD });
  }
  ...
  function showToast(msg, durationMs) {
    ...
    setTimeout(function () { t.remove(); }, durationMs || 1900);
  }
